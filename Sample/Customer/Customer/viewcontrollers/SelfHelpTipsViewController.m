 ...
 */
#import "SelfHelpTipsViewController.h"
#import "ARDVideoCallView.h"
#import "RCManager.h"

@interface SelfHelpTipsViewController(){
...
@implementation SelfHelpTipsViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(enableMayDay)
    name:RCCancel object:nil];
